...
lines = 1756644    #根据train_log_iou.txt的行数修改
result = pd.read_csv('train_log_iou.txt' ,error_bad_lines=False,  skiprows=[x for x in range(lines) if ((x%10!=9) |(x<1000))], names=['Region Avg IOU', 'Class', 'Obj', 'No Obj', 'Avg Recall','count'])
#
result.head()
